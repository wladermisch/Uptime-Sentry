  ...
  const handleCheckUpdates = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (isNewerVersion(latestTag, 'v0.4.0')) {
          ...
          setUpdateStatus('You are running the latest version (v0.4.0).');
        }
      } else {
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <Card variant="outlined" sx={{ height: '100%' }}>
            <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <Divider sx={{ my: 1 }} />
              <Typography variant="body2">Desktop App: v0.4.0</Typography>
              <Typography variant="body2">Java Backend: v0.4.0 (Javalin Server)</Typography>
              <Box sx={{ mt: 1.5 }}>
